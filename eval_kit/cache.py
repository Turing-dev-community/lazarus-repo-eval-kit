...
class EvalCache:
    ...
    def quality_checks_key(
        platform: str, owner: str, repo_name: str, skip_llm: bool
    ) -> str:
        return (
            f"quality:{platform}:{owner}/{repo_name}:{'nollm' if skip_llm else 'llm'}"
        )
    ...
    def set(self, key: str, value: Any) -> None:
        ...
        try:
            ...
            self._cache.set(key, stored, expire=self.ttl)
